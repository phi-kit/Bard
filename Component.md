...
Style: [Description]
Color: [Hex/Name]
Material: [Fabric, Silk, Latex, Metal, Alloy] (Rule: Omit the "Fabric" line entirely for non-fabric components, such as hair or metal jewelry).
...
Step 7: Credit
If the character is from a known IP, mention the character, studio and estimated time of publication. 
